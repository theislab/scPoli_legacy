...
plt.savefig(
    os.path.expanduser(
        f"~/Documents/tranvae_testing/{experiment}_semi/uncertainty.png"
    ),
    bbox_inches="tight",
)
...
if plot_figures:
    ...
    plt.savefig(
        os.path.expanduser(
            f"~/Documents/tranvae_testing/{experiment}_semi/umap_full_tranvae_batch_l.png"
        ),
        bbox_inches="tight",
    )
    ...
    plt.savefig(
        os.path.expanduser(
            f"~/Documents/tranvae_testing/{experiment}_semi/umap_full_tranvae_ct_l.png"
        ),
        bbox_inches="tight",
    )
    ...
    plt.savefig(
        os.path.expanduser(
            f"~/Documents/tranvae_testing/{experiment}_semi/umap_full_tranvae_ct.png"
        ),
        bbox_inches="tight",
    )
    ...
    plt.savefig(
        os.path.expanduser(
            f"~/Documents/tranvae_testing/{experiment}_semi/umap_full_tranvae_pred.png"
        ),
        bbox_inches="tight",
    )
