...
preds, probs = tranvae.classify(
    target_adata.X, target_adata.obs[condition_key], metric="var"
)
print("Distance Classifier:", np.mean(preds == target_adata.obs[cell_type_key]))
text_file = open(
    os.path.expanduser(f"~/Documents/tranvae_testing/{experiment}_surg/acc_report.txt"),
    "w",
)
n = text_file.write(
...
plt.savefig(
    os.path.expanduser(
        f"~/Documents/tranvae_testing/{experiment}_surg/uncertainty.png"
    ),
    bbox_inches="tight",
)
...
plt.savefig(
    os.path.expanduser(
        f"~/Documents/tranvae_testing/{experiment}_surg/umap_full_tranvae_batch_l.png"
    ),
    bbox_inches="tight",
)
...
plt.savefig(
    os.path.expanduser(
        f"~/Documents/tranvae_testing/{experiment}_surg/umap_full_tranvae_ct_l.png"
    ),
    bbox_inches="tight",
)
...
plt.savefig(
    os.path.expanduser(
        f"~/Documents/tranvae_testing/{experiment}_surg/umap_full_tranvae_ct.png"
    ),
    bbox_inches="tight",
)
...
plt.savefig(
    os.path.expanduser(
        f"~/Documents/tranvae_testing/{experiment}_surg/umap_full_tranvae_pred.png"
    ),
    bbox_inches="tight",
)
