...
plt.savefig(os.path.expanduser(f'~/Documents/tranvae_testing/{experiment}_surg/umap_surg_tranvae.png'),
            bbox_inches='tight')
...
plt.savefig(os.path.expanduser(f'~/Documents/tranvae_testing/{experiment}_surg/umap_full_tranvae.png'),
            bbox_inches='tight')

surg_path = os.path.expanduser(f'~/Documents/tranvae_testing/{experiment}_surg/surg_model')
