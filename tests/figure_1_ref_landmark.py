...
tranvae = TRANVAE.load(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/model'), source_adata)

x,y,c,p = tranvae.get_landmarks_info(metric=class_metric, threshold=0.5)

tranvae.add_new_cell_type("Pancreas Delta", [6])

tranvae.save(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/extended_model'), overwrite=True)
...
text_file = open(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/extended_acc_report.txt'), "w")
...
plt.savefig(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/extended_umap_full_tranvae_batch_l.png'),
            bbox_inches='tight')
...
plt.savefig(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/extended_umap_full_tranvae_ct_l.png'),
            bbox_inches='tight')
...
plt.savefig(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/extended_umap_full_tranvae_ct.png'),
            bbox_inches='tight')
...
plt.savefig(os.path.expanduser(f'~/Documents/tranvae_testing/figure_1/extended_umap_full_tranvae_pred.png'),
            bbox_inches='tight')